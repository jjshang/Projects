...
data = pd.read_csv("/Users/jennyshang/Documents/Masters/Masters/Fall 2019/DSO545/Project/For Data Cleaning/Cleaned data/North_Carolina_all_data.csv")
...
## Remove outliers as seen from previous graphs
...
## Set title, x-label, y-label for main graph
ax_main.set(title = "Scatterplot with Boxplots \nNumber of One Bedrooms vs. Price per SQFT",
           xlabel = "Num_1_bed",
           ylabel = "Price_per_sqft")
